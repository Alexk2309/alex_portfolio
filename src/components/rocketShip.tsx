...
function RocketShip () {
    ...
    return (
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" className="bi bi-rocket" viewBox="0 0 16 16" transform='rotate(90)'>
